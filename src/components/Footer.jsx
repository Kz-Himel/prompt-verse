          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex space-x-3 pt-2">
              ...
              <a
                href="#"
                aria-label="Twitter"
                className="p-2 bg-[#EBF1F5] rounded-xl text-[#64748B] hover:text-[#0F766E] shadow-[3px_3px_6px_#d1d9e0,-3px_-3px_6px_#ffffff] border border-white/50 transition-all duration-200 active:scale-95 flex items-center justify-center w-9 h-9"
              >
                <svg
                  width="14"
                  height="14"
