...
export default function AddPromptPage({
  ...
  const [loadingCount, setLoadingCount] = useState(
    passedCount !== undefined ? false : true,
  );
        ...
        >
          ...
          <div className="p-6 space-y-5">
            <Field label="Tags" hint="Up to 8 tags">
              <div
                className={`${inputCls()} min-h-[48px] flex flex-wrap gap-2 p-2 cursor-text`}
              >
                {form.tags.map((t) => (
                  <span
                    key={t}
            ...
            <Field label="Visibility">
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  >
                    <div
                      className={`text-lg mb-1 ${form.visibility === v.value ? "text-violet-600" : "text-slate-400"}`}
                    >
                      {v.icon}
                    </div>
          ...
          <div className="mx-6 mb-6 bg-amber-50 border border-amber-200 rounded-xl p-3.5 flex items-start gap-3">
            ...
            <p className="text-slate-600 text-xs leading-relaxed">
              ...
              <span className="text-amber-700 font-medium">pending</span> and
              will be reviewed by an admin before appearing in the marketplace.
            </p>
          </div>
